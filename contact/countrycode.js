...
function validateForm(event) {
  ...
  const workEmail = document.querySelector('input[placeholder="john@restaurant.com"]');
  const companyName = document.querySelector('input[placeholder="Your Restaurant Group"]');
  const countryInput = document.getElementById('country-input');
