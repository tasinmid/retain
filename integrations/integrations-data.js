const integrations = [
    {
        ...
        iconColor: "foreground-blue-bold",
        backgroundColor: "surface-blue-light",
        subtitle: "Sync customer data seamlessly with your Salesforce CRM",
        tag: "CRM",
        tagBackgroundColor: "surface-blue-light",
        tagTextColor: "foreground-blue-dark"
    },
    {
        name: "Facebook",
        iconType: "fontawesome",
        ...
        iconColor: "foreground-blue-bold",
        backgroundColor: "surface-purple-light",
        subtitle: "Connect with Facebook to engage customers through social media",
        tag: "Social Media",
        tagBackgroundColor: "surface-purple-light",
        tagTextColor: "foreground-purple-dark"
    },
    {
        name: "Shopify",
        iconType: "fontawesome",
        iconClass: "fab fa-shopify",
        iconColor: "foreground-purple-bold",
        backgroundColor: "surface-purple-light",
    ...
    },
    {
        ...
        iconColor: "foreground-pink-bold",
        backgroundColor: "surface-blue-light",
    ...
    },
    {
        ...
        iconColor: "foreground-green-bold",
        backgroundColor: "surface-green-light",
        subtitle: "Sync customer contacts and email campaign data",
        tag: "Email Marketing",
        tagBackgroundColor: "surface-green-light",
        tagTextColor: "foreground-green-dark"
    },
    {
        name: "Messenger",
        iconType: "fontawesome",
        iconClass: "fab fa-facebook-messenger",
        iconColor: "foreground-blue",
        backgroundColor: "surface-blue-light",
    ...
    },
    {
        ...
        iconColor: "foreground-green",
        backgroundColor: "surface-yellow-light",
        subtitle: "Connect your WhatsApp Business account for customer messaging",
        tag: "Communication Channel",
        tagBackgroundColor: "surface-yellow-light",
        tagTextColor: "foreground-yellow-dark"
    },
    {
        name: "Twitter (X)",
        iconType: "fontawesome",
        iconClass: "fab fa-twitter",
        iconColor: "foreground-blue-light",
        backgroundColor: "surface-blue-light",
    ...
    },
    {
        ...
        iconColor: "foreground-indigo-bold",
        backgroundColor: "surface-indigo-light",
        subtitle: "Connect with HubSpot CRM to manage customer relationships",
        tag: "CRM",
        tagBackgroundColor: "surface-indigo-light",
        tagTextColor: "foreground-indigo-dark"
    },
    {
        name: "Telegram",
        iconType: "fontawesome",
    ...
    },
    {
        ...
        tagBackgroundColor: "surface-teal-light",
        tagTextColor: "foreground-teal-dark"
    },
    {
        name: "Discord",
        iconType: "fontawesome",
    ...
    },
    {
        ...
        iconColor: "foreground-purple-bold",
        backgroundColor: "surface-purple-lighter",
        ...
        tags: [
            {
                ...
                backgroundColor: "surface-indigo-light",
                textColor: "foreground-indigo-dark"
            },
            {
                text: "Communication Channel",
                backgroundColor: "surface-blue-light",
                textColor: "foreground-blue-dark"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        tag: "Automation Tool",
        tagBackgroundColor: "surface-red-light",
        tagTextColor: "foreground-red-dark"
    },
    {
        name: "Viber",
        iconType: "fontawesome",
    ...
    },
    {
        ...
        tag: "Automation Tool",
        tagBackgroundColor: "surface-pink-light",
        tagTextColor: "foreground-pink-dark"
    },
    {
        name: "Voiceflow",
        iconType: "svg",
        ...
        svgViewBox: "0 0 24 24",
        iconColor: "foreground-slate-dark",
        backgroundColor: "surface-slate-light",
        subtitle: "Connect with Voiceflow to design and deploy voice experiences",
        tag: "AI Automation",
        tagBackgroundColor: "surface-slate-light",
        tagTextColor: "foreground-slate-dark"
    },
    {
        name: "Botpress",
        iconType: "fontawesome",
        ...
        iconColor: "foreground-blue-bold",
        backgroundColor: "surface-blue-lighter",
    ...
    },
    {
        ...
        svgViewBox: "0 0 32 32",
        iconColor: "foreground-amber-bold",
        backgroundColor: "surface-amber-lighter",
        subtitle: "Connect with Vapi to create voice-enabled applications",
        tag: "AI Automation",
        tagBackgroundColor: "surface-amber-light",
        tagTextColor: "foreground-amber-dark"
    },
    {
        name: "OpenAI",
        iconType: "svg",
        ...
        tag: "AI Model",
        tagBackgroundColor: "surface-emerald-light",
        tagTextColor: "foreground-emerald-dark"
    },
    {
        name: "Zapier",
        iconType: "svg",
        ...
        iconColor: "foreground-orange",
        backgroundColor: "surface-orange-lighter",
        subtitle: "Connect with 5000+ apps and automate workflows without code",
        tag: "Automation Tool",
        tagBackgroundColor: "surface-orange-light",
        tagTextColor: "foreground-orange-dark"
    },
    {
        name: "Trello",
        iconType: "fontawesome",
